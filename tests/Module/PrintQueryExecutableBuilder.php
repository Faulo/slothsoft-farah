...
class PrintQueryExecutableBuilder implements ExecutableBuilderStrategyInterface, ResultBuilderStrategyInterface {
    ...
    public function buildResultStrategies(ExecutableInterface $context, FarahUrlStreamIdentifier $type): ResultStrategies {
        $delegate = function () use ($context): string {
            ...
            return "<print-query xmlns='http://schema.slothsoft.net/farah/module' args='$args'/>";
        };
